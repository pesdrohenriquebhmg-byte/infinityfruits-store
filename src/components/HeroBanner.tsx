...
const HeroBanner = () => {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-8 pb-12 md:pt-20 md:pb-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <h1 className="font-display text-[26px] sm:text-4xl md:text-5xl lg:text-6xl font-black text-foreground leading-[1.1] tracking-tight mb-4">
              A maneira mais{' '}
            ...
            <p className="text-sm md:text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-6 leading-relaxed">
            ...
            {/* Botões de suporte */}
            <div className="grid grid-cols-2 sm:flex sm:flex-row gap-2.5 sm:gap-3 justify-center lg:justify-start mb-8">
              <a
                href={WHATSAPP_LINK}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 h-12 px-3 sm:px-5 rounded-xl bg-[hsl(142_70%_45%)] text-white font-display font-bold text-[11px] sm:text-xs uppercase tracking-wider hover:brightness-110 transition-all shadow-[0_8px_24px_-8px_hsl(142_70%_45%_/_0.6)]"
              >
                <MessageCircle className="w-4 h-4 shrink-0" />
                <span className="truncate">Suporte WhatsApp</span>
              </a>
              <a
                href={DISCORD_LINK}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 h-12 px-3 sm:px-5 rounded-xl bg-[hsl(235_86%_65%)] text-white font-display font-bold text-[11px] sm:text-xs uppercase tracking-wider hover:brightness-110 transition-all shadow-[0_8px_24px_-8px_hsl(235_86%_65%_/_0.6)]"
              >
                ...
                <span className="truncate">Server Discord</span>
              </a>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative">
              ...
              <img
                ...
                height="420"
                decoding="async"
                className="relative w-40 h-40 sm:w-56 sm:h-56 md:w-80 md:h-80 lg:w-96 lg:h-96 object-contain drop-shadow-[0_20px_40px_hsl(200,80%,50%,0.25)] animate-float"
              />
            </div>
          </div>
        </div>
