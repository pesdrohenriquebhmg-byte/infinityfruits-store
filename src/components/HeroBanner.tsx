          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-8">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 h-11 px-5 rounded-xl bg-[hsl(142_70%_45%)] text-white font-display font-bold text-xs uppercase tracking-wider hover:brightness-110 transition-all shadow-[0_8px_24px_-8px_hsl(142_70%_45%_/_0.6)]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 h-11 px-5 rounded-xl bg-[hsl(235_86%_65%)] text-white font-display font-bold text-xs uppercase tracking-wider hover:brightness-110 transition-all shadow-[0_8px_24px_-8px_hsl(235_86%_65%_/_0.6)]"
              >
